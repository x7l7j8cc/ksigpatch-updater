...
#define CURSOR_LIST_MAX         5 //On-SCREEN OPTION LIST -1
...
#define LOPTION_3       "Install Sigpatches by HarukoNX"
#define LOPTION_4       "Remove Nichole-Logo from Kosmos Boot"
#define LOPTION_5       "Remove SigPatches from Kosmos"
#define LOPTION_6       "Update this App"

//#define LIOPTION_1      "Update Kosmos (Mini) Sigpatches (ES/FS Only)"
//#define LIOPTION_2      "Update Kosmos (Full) Sigpatches (for Tinfoil Support)"
//#define LIOPTION_3      "Update Sigpatches by HarukoNX"